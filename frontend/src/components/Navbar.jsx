    ...
    <>
      <div className="nav flex px-[100px] items-center justify-between h-[90px] bg-[#0f0e0e]">
        ...
        <div className="links flex items-center gap-[15px]">
          ...
          <Link to="/" className=' transition-all hover:text-blue-500'>About</Link>
          <Link to="/" className=' transition-all hover:text-blue-500'>Services</Link>
          <Link to="/" className=' transition-all hover:text-blue-500'>Contact</Link>
          <button onClick={()=>{
