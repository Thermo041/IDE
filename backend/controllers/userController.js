...
exports.saveProject = async (req, res) => {
  try {
    ...
    let project = await projectModel.findOneAndUpdate({ _id: projectId, createdBy: user._id }, { code: code });
...
exports.deleteProject = async (req, res) => {
  try {
    ...
    let project = await projectModel.findOneAndDelete({ _id: projectId, createdBy: user._id });
